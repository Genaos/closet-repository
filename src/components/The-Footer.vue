  ...
  <section class="footer_area">
    <div class="footer_area_items_wrapper">
        ...
        <ul class="footer_items_wrapper">
            ...
            <li>
                <a class="footer_item_link">Договор оферты</a>
            </li>
            <li>
                <a class="footer_item_link">Доставка и оплата</a>
            </li>
            <li>
                <a class="footer_item_link">Обмен и возврат</a>
            </li>
            <li>
    ...
    <div class="footer_area_contact_wrapper">
        <form class="footer_area_contact_form">
            <fieldset>
                <legend class="footer_area_contact_form_title">Подписка на акции и новости</legend>
                <div class="footer_area_form_input_wrapper">
                    <input class="footer_area_form_input" type="email" id="mail" placeholder=" " required>
                    <label class="footer_area_form_input_label" for="mail">Ваша почта</label>   
                    <button class="footer_area_input_submit">
                        <span class="material-symbols-outlined">send</span>
                    </button>
                </div>
                <span class="footer_area_input_prompt">Отправляя свой e-mail, вы соглашаетесь с политикой конфиденциальности</span>
            </fieldset>
        </form>
        <ul class="footer_area_contacts">
            <li class="footer_area_contacts_title">
                Мы на связи
                <span class="footer_area_contacts_prompt">Ежедневно с 9:00 до 20:00</span>
            </li>
            <li>
                <a class="footer_item_link_wrapper">
                    <span class="material-symbols-outlined">call</span>
                    <span class="footer_item_link">+7 999 987 78 89</span>
                </a>
            </li>
            <li>
                <a class="footer_item_link_wrapper">
                    <span class="material-symbols-outlined">mail</span>
                    <span class="footer_item_link">contact@shkafbrerry.ru</span>
                </a>
            </li>
            <li>
                <a class="footer_item_link_wrapper">
                    <span class="material-symbols-outlined">location_on</span>
                    <span class="footer_item_link">Санкт-Петербург, Рижская ул., д.9 к.2</span>
                </a>
            </li>
        </ul>
    ...
    <div class="footer_prompt_info">
        <span class="footer_area_contacts_prompt">© 2022 Шкафбери</span>
    </div>
  </section>
</template>
...
.footer_area_form_input:not(:placeholder-shown) ~ .footer_area_form_input_label {
    font-weight: 500;
    font-size: 12px;
    line-height: 16px;
